  ...
  return (
    ...
    <div className="register">
      <form className="form" onSubmit={onSaveUserClicked}>
        ...
        <div>
        <Tooltip 
        title="Enter a valid username (5-20 characters) with letters, numbers, underscores, and hyphens." 
        placement="right"
        open={usernameError!==''}>
          <TextField
        ...
        <Tooltip 
        title="Enter a valid password (8-25 characters) contains at least one uppercase and one lowercase letter, one special character (!, @, #, $, or %), and one number."
        placement="right"
        open={passwordError!==''}
          >
        <TextField
